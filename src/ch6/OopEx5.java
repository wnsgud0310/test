 ...
 *      
 *   interface의 구현
 *      - 추상 메소드를 구현하는 클래스에서 implements 를 사용해서 구현.
 *   
 * 
 */
...
/**
 * 
 * interface 를 활용 - 반환타입에 적용하면 결합도가 낮아짐.
 * 					-java의 jdbc 임.
 * 
 * 구문 분석 기능을 구현
 * 
 ...
 * 	 파싱 기능을 호출하는 쪽에서는 변경에 대한 영향이없도록 구현하는 것이 중요함
 * 
...
// 최신의 Parser 가 사용되도록 함. => XMLParser 의 변경이 main method 에서
