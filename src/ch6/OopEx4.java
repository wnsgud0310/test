 ...
 *      람다( serverless  - 개발자가 작성한 코드가 실행. 개잘자가 서버 관리 안해도 됨.)  
 ...
 *      			
 *      class Singleton{
 *      	private static Sington s = new Singleton();
 *      
 ...
 *    	static 
 *    		멤버 변수 - 모든 인스턴스에서 공통적으로 사용되는 클래스가 변수가 됨.
 ...
 *          멤버 메소드 - 인스턴스를 생성하지 않고, 호출이 가능한 static 메소드가 됨.
 ...
 *             		생성자에서 초기화를 수행해야함 .따라서, 인스턴스별로 다른 값을 가지게 됨.
 *             
 *             보통은 선언과 동시에 초기화. 
 *             
 *             
...
public class OopEx4 {
	...
	public static void main(String[] args) {
		...
		Product3[] itemList = new Product3[10];
		// 구매할 수 있는 상품수는 10개임. 
